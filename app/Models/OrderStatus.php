...
class OrderStatus extends Model
{
    ...
    {
        return $this->stausQuery($query, \App\Enums\OrderStatus::InProcess);
    }

    public function scopePaid(Builder $query): Builder
    {
        return $this->stausQuery($query, \App\Enums\OrderStatus::Paid);
    }

    public function scopeCanceled(Builder $query): Builder
    {
        return $this->stausQuery($query, \App\Enums\OrderStatus::Canceled);
    }

    public function scopeCompleted(Builder $query): Builder
    {
        return $this->stausQuery($query, \App\Enums\OrderStatus::Completed);
    }

    protected function stausQuery(Builder $query, \App\Enums\OrderStatus $enum): Builder
    {
